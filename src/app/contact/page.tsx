...
export const metadata: Metadata = {
  title: "Contact Our Engineering Team | Mylotic Group",
  description:
    "Direct channels to initiate enterprise technology consultations, architectural reviews, technical staffing inquiries, and managed services requests with Mylotic Group.",
};
