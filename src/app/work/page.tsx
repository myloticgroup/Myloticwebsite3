...
export const metadata: Metadata = {
  title: "Selected Engagements & Work | Mylotic Group",
  description:
    "Explore verified client engagements, architectural case studies, and engineering outcomes delivered by Mylotic Group.",
};
