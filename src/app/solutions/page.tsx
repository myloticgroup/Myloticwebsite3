...
export const metadata: Metadata = {
  title: "Enterprise Solutions & Technical Practices | Mylotic Group",
  description:
    "Explore Mylotic Group's full-lifecycle technology practices: Applied AI, custom software engineering, cloud modernization, talent staffing, managed services, and EdTech.",
};
