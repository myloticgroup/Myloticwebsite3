...
export const metadata: Metadata = {
  title: "Industry Verticals & Domain Engineering | Mylotic Group",
  description:
    "Tailored engineering architectures designed for AI & Intelligent Technology, IT & Digital Technology, Global Capability Centers, Financial Services, Education, Digital Media, and Enterprise Software.",
};
