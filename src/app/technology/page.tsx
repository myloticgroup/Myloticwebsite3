...
export const metadata: Metadata = {
  title: "Technology Stack & Architecture Matrix | Mylotic Group",
  description:
    "Explore Mylotic Group's verified engineering technology stack across Applied AI, full-stack web platforms, distributed cloud microservices, and automated CI/CD DevOps pipelines.",
};
