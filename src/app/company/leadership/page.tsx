...
export const metadata: Metadata = {
  title: "Executive Leadership & Governance | Mylotic Group",
  description:
    "Meet the executive leadership and corporate governance team guiding Mylotic Group's technology vision.",
};
