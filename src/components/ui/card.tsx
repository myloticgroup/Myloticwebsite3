...
const variantClasses: Record<NonNullable<CardProps["variant"]>, string> = {
  ...
  interactive:
    "bg-surface border-border hover:border-border-hover hover:bg-surface transition-all duration-200 cursor-pointer shadow-subtle hover:shadow-card",
  ...
  ({ className, variant = "default", children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "rounded-lg border text-foreground overflow-hidden",
